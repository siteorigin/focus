 ...
 */
function focus_siteorigin_widgets_enqueue_widget_scripts() {
...
add_action( 'wp_enqueue_scripts', 'focus_siteorigin_widgets_enqueue_widget_scripts' );
	...
	function form( $instance ) {
		...
		<p>
			...
			<select name="<?php echo $this->get_field_name( 'icon' ) ?>" id="<?php echo $this->get_field_id( 'icon' ) ?>">
				<option value="0" <?php selected( !empty($instance['icon']) ) ?>><?php echo esc_html_e('None', 'siteorigin') ?></option>
 ...
 */
function focus_siteorigin_widgets_init() {
...
add_action( 'widgets_init', 'focus_siteorigin_widgets_init' );